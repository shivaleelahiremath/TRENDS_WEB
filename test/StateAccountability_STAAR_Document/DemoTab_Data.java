...
public class DemoTab_Data {
	...
	public void populate_DemotabData(WebDriver driver) throws InterruptedException{
        ...
        Thread.sleep(2000);
		List<WebElement> Demo = driver.findElements(By.id("AccountabilityAssessmentDemogBreakdown"));	            	
...
//					System.out.println("PF -> pass and fail values are matching..");
		...
		WebElement test = driver.findElement(By.xpath("//*[@id='AccountabilityAssessmentDemogBreakdown']/tr/th[3]/filter/div/input"));
		test.clear();
...
//					System.out.println("Gender -> pass and fail values are matching..");
		...
		WebElement test1 = driver.findElement(By.xpath("//*[@id='AccountabilityAssessmentDemogBreakdown']/tr/th[3]/filter/div/input"));
		test1.clear();
...
//					System.out.println("Ethnicity -> pass and fail values are matching..");
