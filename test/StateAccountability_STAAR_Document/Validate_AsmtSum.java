...
//				System.out.println(Criteria[i]+" : Summary tab "+SummaryData[i]+" != Assessment tab "+AsmtData[i]);
	...
	void validatePercentageCriteria(double[] AsmtData, double[] SummaryData, String[] Criteria){
		for(int i=0; i< AsmtData.length; i++){
