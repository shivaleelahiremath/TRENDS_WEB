...
public class STAAR_SAccountDoc_SANITY_TEST {
	...
	//		System.out.println("Item analysis tab question count:  "+ItemTabCount);
		...
		//	System.out.println("selected Student tab..");
			...
			//		System.out.println("Expected is " +StudSECount+ " and found is "+SECount);
					...
					debugLog.error("SE Mastery count is not matching for document: "+DocTitle );
					debugLog.error("Expected on student filter option is " +StudSECount+ " and found SE Mastery tab is "+SECount);
				}
			}catch(Exception e){
		...
		//	System.out.println("Selected summary tab..");
			...
			if(RemeQsCount > 0){
				...
				//	System.out.println("Expected is " +SumQsCount+ " and found is "+RemeQsCount);
					...
					debugLog.error("Expected on summary tab is " +SumQsCount+ " and found on remediation tab is "+RemeQsCount);
				}
			}else{
				System.out.println("No data found on Remedation tab for document: "+DocTitle);
			}
			...
			//	System.out.println("Expected is " +SumQsCount+ " and found is "+ItemTabCount);
				...
				debugLog.error("Expected on summary tab is " +SumQsCount+ " and found on Item analysis tab is "+ItemTabCount);
			}
		}
