...
public class SAccount_DocScoreDetails_TS_BISDTest03 {
...
//		login.get("http://trends.tangosoftware.com");
	...
	public void VerifyDocumentScoreDetails(String DocTitle, String AdminMode, String AdminSeries) throws InterruptedException{			
		...
		login.findElement(By.xpath("html/body/content/div/div[2]/div/div/div/div[1]/div/table/thead/tr/th[7]/main/left")).click();
		Thread.sleep(4000);
