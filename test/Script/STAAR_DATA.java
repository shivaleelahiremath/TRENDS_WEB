...
//	}
	...
	public void DocumentVerify(String DocTitle, String AdminCode, String AdminSeries, String AdminMode, String Language, String Target, String Subject, WebDriver login) throws InterruptedException
	{
		...
		login.findElement(By.id("ui-id-10")).click();
		Thread.sleep(3000);	
		
		//to select year on assessment tab only for Harligen City..
//	    login.findElement(By.xpath("html/body/header/bottom/toolbar/form/div[1]/a/span[1]")).click();
//	    login.findElement(By.xpath("html/body/div[21]/ul/li[3]/div")).click();
...
//		Thread.sleep(3000);
	...
	public void AssessmentTabScoreDetails(String DocTitle, WebDriver login) throws InterruptedException{
		...
		String PassTallyRight1 =AsmtData.findElement(By.xpath("tbody/tr["+rowCount+"]/td[14]/right")).getText();
		int PassTallyRight = Integer.parseInt(PassTallyRight1);

		String FailTallyRight1 =AsmtData.findElement(By.xpath("tbody/tr["+rowCount+"]/td[15]/right")).getText();
		int FailTallyRight = Integer.parseInt(FailTallyRight1);

		String TotalTakenStud1 = AsmtData.findElement(By.xpath("tbody/tr["+rowCount+"]/td[16]")).getText();
		int TotalTakenStud = Integer.parseInt(TotalTakenStud1.replace(",", ""));

		String TotalNonTakenStud1 = AsmtData.findElement(By.xpath("tbody/tr["+rowCount+"]/td[17]")).getText();
		...
		for(int l=0;l<AsmtTabData.length;l++){
			AsmtTabValues[l] = AsmtData.findElement(By.xpath("tbody/tr["+rowCount+"]/td["+(l+18)+"]/right")).getText();				  
		}
		...
		String Incomplete = AsmtData.findElement(By.xpath("tbody/tr["+rowCount+"]/td[25]")).getText();
		...
		for(int m=0;m<AsmtTabData.length;m++){
			String AsmtPer = AsmtData.findElement(By.xpath("tbody/tr["+rowCount+"]/td["+(m+18)+"]/left")).getText();
			...
			for(int task1=0; task1 < SumFilter_Task.length; task1++){	
				...
				if(StudTask.equalsIgnoreCase(SumTask)){
					...
					if(StudCount == SumCount){
						...
						debugLog.error(StudTask.trim()+ ": Student tab "+StudCount+" != Summary tab "+SumCount);
	...
	public void DemoGraphySummaryVerify(WebDriver login) throws InterruptedException{
		...
		System.out.println("demography verify...");
