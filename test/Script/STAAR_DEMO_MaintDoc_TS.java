...
public class STAAR_DEMO_MaintDoc_TS {
...
//	        System.out.println("assessment data: "+DemoData.getText());
			...
			WebElement test = login.findElement(By.xpath("//*[@id='MaintenanceAssessmentDemogBreakdown']/tr/th[3]/filter/div/input"));
			test.clear();
			...
			WebElement test1 = login.findElement(By.xpath("//*[@id='MaintenanceAssessmentDemogBreakdown']/tr/th[3]/filter/div/input"));
			test1.clear();
