...
public class Kentro_DemoTab_Data {
	...
	public void populate_DemotabData(WebDriver driver) throws InterruptedException{
        ...
        Thread.sleep(2000);
		List<WebElement> Demo = driver.findElements(By.id("MaintenanceAssessmentDemogBreakdown"));	            	
...
//				    System.out.println("PassFailArray fail Value " + PF_passFailArray[i][k]);
		...
		//*[@id="DemoGroup"]/div/input

		// Filtering and selecting gender details..
		WebElement test = driver.findElement(By.xpath("//*[@id='MaintenanceAssessmentDemogBreakdown']/tr/th[3]/filter/div/input"));
		test.clear();
...
//		    System.out.println("Demo tab task: " +GenderOption[i]+" not taken student count : "+DemoGen_NotTaken[i]+" and taken student count: "+DemoGen_Taken[i]);
		...
		WebElement test1 = driver.findElement(By.xpath("//*[@id='MaintenanceAssessmentDemogBreakdown']/tr/th[3]/filter/div/input"));
		test1.clear();
